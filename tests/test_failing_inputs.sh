...
code=$(get_return_code '-d @dataids/no-column-nan.jsonld -H "Content-Type: application/json+ld" http://localhost:3002/file/save?repo=testing&path=test/no-column-nan.jsonld')
