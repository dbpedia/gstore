...
code=$(post_return_code_contenttype_applicationldjson  "http://localhost:3002/file/save?repo=janni&path=testing/empty_post.jsonld" @data/none )
...
code=$(post_return_code_contenttype_applicationldjson  "http://localhost:3002/file/save?repo=janni&path=testing/no-column-nan.jsonld" @data/fail_datatype_no-column-nan.jsonld )
assert_eq "$code" "400" "Writing No column NaN to GStore"

code=$(post_return_code_contenttype_applicationldjson  "http://localhost:3002/file/save?repo=janni&path=testing/syntax_error.jsonld" @data/fail_syntax_group.jsonld )
